...
<!-- Owl carousel -->
  <link rel="stylesheet" href="<?php echo get_bloginfo('template_directory'); ?>/owlcarousel/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="<?php echo get_bloginfo('template_directory'); ?>/owlcarousel/assets/owl.theme.default.min.css">
