...
<?php $array  = get_post_meta($post->ID, '_yourprefix_text', true);
...
foreach($array as $key => $value){
 ...
 if($isFirst){
  ...
  $isFirst = false;
    ...
    echo " <div class='float-right text-muted'>Mon, Jan 9th 2020 7:00 AM</div>";   
    echo "<h4 class='card-title'>Day ".$day_number. " Orientation</h4>";   
